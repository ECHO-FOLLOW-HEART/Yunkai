...
import com.lvxingpai.yunkai.service.{ MorphiaFactory, RedisFactory, SmsCenter }
 ...
 *
 */
object AccountManagerImpl extends AccountManager {
  ...
  def createUser(nickName: String, password: String, tel: Option[String]): Future[UserInfo] = {
    ...
    // 取得用户ID
    val futureUserId = IdGenerator.generateId("yunkai:idgenerator/default")(futurePool)
